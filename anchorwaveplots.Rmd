...
y.grob <- textGrob("Maternal Haplotype\nposition(Mb)",gp=gpar(fontface="bold", fontsize=12), rot=90)

x.grob <- textGrob("Paternal Haplotype\nposition(Mb)",gp=gpar(fontface="bold", fontsize=12))
...
ggsave(plot=labeledplot,"draft3_dotplot.tiff",width=14,height=10,dpi="print",device="tiff")
```
