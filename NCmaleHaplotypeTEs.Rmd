...
fig3 <- 
  landscapeFraction / (TEsexChromosomes | TEfamCountOneToOne) / biggestFamBars +
  ...
  title = "Figure 3",
  tag_levels = "A", 
  caption = "(A) The fraction of genes in the window is from Haplotype 2, except for X, which has TEs from Haplotype 1 and the genes that lifted well from H1.  (B) Fraction of the region occupied by Genes.  (C) Fraction of the region occupied by TEs."
)

fig3 #quick preview to double-check

# Save the plot as figure3.png "with sensible defaults"
ggsave("figure3.png", plot = fig3, width = 10, height = 13)
